		...
		<div id="bodyContainer" class="startContainer">
			<table id="timerTable">
				<form id="timerForm">
					<!-- Work Timer Dropdown -->
					<tr>
						<td colspan="3"><h2>Set Work Timer:</h2></td>
						...
						<td colspan="2"><p>minutes</p></td>
					</tr>
					<!-- Break Timer Dropdown -->
					<tr>
						<td colspan="3"><h2>Set Break Timer:</h2></td>
					...
					<!-- Start Button -->
					<tr>
						<td colspan="7" style="text-align:center; padding-top: 0.5em;">

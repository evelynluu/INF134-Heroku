        ...
        function restart()
        {
            ...
            controlDiv.innerHTML = "Control Snake: UP, DOWN, LEFT, RIGHT";
        ...
        function keydown(e)
        {
            ...
            else if (e.keyCode == 32 && isPaused)	// space - resumes game from "pause"
            {
				isPaused = false;
                intervalId = setTimeout(gameProcess, 1000 /(6*level));
            }

            else if (e.keyCode == 32 && !isPaused)	// space - pause game
			{
				isPaused = true;
